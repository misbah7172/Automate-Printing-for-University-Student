 ...
 * This script initializes a local SQLite database with tables and sample data
 */
...
const PrintJobModel = require('./src/models/PrintJob');
...
const PrintJob = PrintJobModel(sequelize, Sequelize.DataTypes);
